...
$input_data = file_get_contents("https://ipl4you.tk/4.m3u");
...
foreach($lines as $line){
    ...
    $license_type = getStringBetween($line, "#KODIPROP:inputstream.adaptive.license_type=", "\n");
    $video_link = getStringBetween($line, "\n", "\n");
